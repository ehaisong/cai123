CREATE OR REPLACE FUNCTION public.merchant_agents_with_stats()
 RETURNS TABLE(user_id uuid, agent_code text, l1_rate numeric, created_at timestamptz, nickname text, phone text, user_code text, customer_count bigint, yesterday_income numeric)
